...
namespace Assets.External.NData.NDataExamples.TextureLoader {
    ...
    public class TextureLoaderContext : EZData.Context
    {
        ...
        private readonly EZData.Property<string> _privateImageUrlProperty = new EZData.Property<string>("http://diversido-mobile.com/assets/templates/diversido/img/logo.png");
