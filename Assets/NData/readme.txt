...
More details on: http://diversido-mobile.com/
...
Version 1.0.21
==============
	NGUI 3.5.3 compatibility fixes
	Binding to fields support
	Windows Phone reflection workaround (thanks to Nick Prühs)

Version 1.0.20
==============
	Fields supported as binding targets and nodes
